...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _superagent2.default // using superagent
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/users', render: function render() {
            return _react2.default.createElement(_UserList2.default, { users: _this3.state.users });
          } }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/users/:id', render: function render(routerProps) {
            var profile = _this3.state.users.find(function (user) {
              return user.id === Number(routerProps.match.params.id);
            });
            return profile ? _react2.default.createElement(_User2.default, { user: profile }) : null;
          } })
      );
    }
  }]);
...
var UserList = function UserList(props) {
  return _react2.default.createElement(
    ...
    props.users.map(function (user) {
      // go through all data and return by id their name.
      return _react2.default.createElement(
        _reactRouterDom.Link,
